import { VectorModel, Message, Conversation } from "../models/index.js";
...
export const chatController = async (req, res, next) => {
    try {
        const { question, vectorProfileId, conversationId, topK = apiConfig.llm.retrieve.topK, role, benchmark } = req.body;
